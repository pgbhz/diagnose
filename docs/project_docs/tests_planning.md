...
Este documento estabelece o plano de testes para o Sistema de Teleodontologia Automatizada via chatbot WhatsApp, desenvolvido para facilitar triagem odontológica remota utilizando componentes de IA.
